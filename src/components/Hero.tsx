        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 py-6">
              <div className="text-center">
                <Shield
                  className="w-8 h-8 mx-auto mb-2 text-secondary-400"
                  weight="duotone"
                />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                size="lg"
                className="bg-secondary-500 hover:bg-secondary-600 text-white font-bold transform hover:scale-105 shadow-lg text-lg"
              >
          ...
          >
            <div className="relative">
                ...
                <div className="aspect-video bg-gradient-to-br from-white/20 to-white/10 rounded-xl flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="w-20 h-20 mx-auto mb-4 bg-white/20 rounded-full flex items-center justify-center">
                      <ImageIcon className="w-10 h-10" weight="duotone" />
                    </div>
              ...
              <Badge className="absolute -bottom-6 -right-6 bg-white text-neutral-900 p-4 rounded-lg shadow-xl border-0">
                <div className="text-center">
